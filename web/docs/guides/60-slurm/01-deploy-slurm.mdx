...
The service should be accessible at the address `slurm-cluster-<cluster name>-db-0.slurm-cluster.svc.cluster.local`.
...
The issue is tracked at [SquareFactory/cluster-factory-ce#29](https://github.com/SquareFactory/cluster-factory-ce/issues/29) and [projectcalico/calico#5199](https://github.com/projectcalico/calico/issues/5199).
