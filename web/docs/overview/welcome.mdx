...
Cluster Factory CE is an open-source k8s-based infrastructure orchestration tool that automates the process of deploying, managing and monitoring compute-optimized clusters from bare metal servers to VMs and containers.
